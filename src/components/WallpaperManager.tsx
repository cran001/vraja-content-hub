...
export default function WallpaperManager() {
  ...
  const handleDelete = async (wallpaperId: string) => {
    ...
    try {
      ...
      const res = await fetch(`/api/admin/wallpapers?id=${wallpaperId}`, {
        method: 'DELETE',
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        {/* FIXED: Re-added the missing upload form section */}
        <div className="lg:col-span-1 p-6 bg-white rounded-lg shadow-md h-fit">
